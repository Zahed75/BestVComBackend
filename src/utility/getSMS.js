const getSMSText = (orderStatus, customerName, order) => {
  ...
  const translateOrderStatus = (status) => {
    const statusMap = {
      'Order Placed': 'গ্রহণ করা হয়েছে',
      'Order Confirmed': 'নিশ্চিত করা হয়েছে',
      'Ready for Delivery': 'প্রেরিত করা হয়েছে',
      'Order Dispatched': 'সরবরাহ করা হয়েছে',
      'On-Hold': 'স্থগিত রাখা হয়েছে',
      'Cancelled': 'বাতিল করা হয়েছে',
      'Order Delivered': 'স্প্যাম হিসাবে চিহ্নিত করা হয়েছে',
    };
